...
export const CHRONICLE_T3_36: LocalizedModalContent = {
  ...
  rawText: {
    ...
    fr: `<p>Quand l’intervieweuse lui a demandé : « Est-ce que vous avez raconté cet événement à l’<b><u>{1}Unité de Victimes{/1}</u></b>? Figurez-vous sur les registres ? », elle a répondu : « Non, comme je vous l’ai déjà dit, j’avais trop peur pour parler, madame. Je n’ai rien raconté. C’est la première fois que j’en parle. J’ai… Nous sommes dans le <b><u><i>{2}monte{/2}</u></b>... Je pense souvent aux conséquences, vous voyez ? Si vous racontez ce qui s’est passé, à tout moment la guérilla peut venir, tirer sur votre famille et tuer tout le monde, et après, qu’est-ce qu’on peut faire ? »</p><p><i>Femme autochtone wanano, citadine</i></p>`,
    en: `<p>When the interviewer asked her: “Did you tell this to the <b><u>{1}Victims Unit{/1}</u></b>? Are you registered?” She replied: “No, as I told you, I couldn’t because I was too afraid, ma’am. I’ve never told anyone. This is the first time I am ever telling somebody. I feel... You know that we are here in the <b><u><i>{2}monte{/2}</u></b>... I think a lot about this, right? If you tell someone about what happened, guerrillas may come anytime, shoot down your family and kill everything. What do you do then?”</p><p><i>Woman, Indigineous Wanano, urbanite</i></p>`,
  },
  tooltips: {
    1: {
      es: `<p>Nota de ejemplo para la crónica T3-36.</p>`,
      fr: `<p><strong>Unité de Victimes</strong></p>
      <p>L’Unité de Victimes (Unidad de Víctimas) vise à rapprocher l’État des victimes grâce à une coordination efficace et à des actions transformatrices qui favorisent la participation active des victimes dans leur processus de réparation. Elle est chargée de coordonner l'assistance, de la prise en charge des victimes et des mesures de réparation fournies par l'État, ainsi que de relier les organismes qui font partie du Système national d'assistance et de réparation globales aux victimes.</p>
      <p><a href="https://www.unidadvictimas.gov.co/resena-de-la-unidad/" target="_blank" rel="noopener noreferrer">Site officiel</a></p>`,
      en: `<p><strong>Victims Unit</strong></p>
      <p>Victims Unit (Unidad de Víctimas) seeks to bring the State closer to victims through efficient coordination and transformative actions that promote the effective participation of victims in their reparation process. It is responsible for coordinating the assistance, care, and reparation measures provided by the State, as well as for connecting the entities that are part of the National System for Comprehensive Attention and Reparation of Victims. </p>
      <p><a href="https://www.unidadvictimas.gov.co/resena-de-la-unidad/" target="_blank" rel="noopener noreferrer">Official website</a></p>`,
    },
    2: {
      es: `<p>Nota de ejemplo para la crónica T3-36.</p>`,
