...
export const CHRONICLE_T3_01: LocalizedModalContent = {
  ...
  rawText: {
    ...
    fr: `<p>« De temps en temps ma compagne est triste, et quand je me rends compte qu’elle pleure je lui demande “qu’est ce qui t’arrives pourquoi tu pleures ?”. Elle me répond “Non c’est que moi sur ma terre... et on doit s’en aller à cause de certains, abandonner son ancien vie”. Là-bas elle travaillait au champ, ici non. Ducoup la situation change du jour au lendemain, autant psychologiquement que physiquement. Après avoir vécu un conflit armé et être arrivé dans une nouvelle ville, la vie change forcément. Tes origines, tes traditions, tout ce que tu aimais faire… Au moins, à Corinto, on faisait des <b><u><i>{1}kermesses{/1}</i></u></b>, mais ici on ne fait rien de tout ça. Comme il y a pas mal de <b><u><i>{2}fincas{/2}</i></u></b>, presque toutes les familles se réunissent dans un même <b><u><i>{3}vereda{/3}</i></u></b> et on fait des fêtes, on fait des barbecues. Ça n'arrive pas ici. Ici c’est chacun pour soi. À Corinto on dit : “Allez, allons semer telles choses, à tel endroit, dans telle <i>finca</i>” et tout le monde y va ».</p><p><i>Femme lesbienne, autochtone, leader</i></p>`,
    en: `<p>“My partner sometimes hangs around, and then, all of a sudden, she starts crying. I ask her, ‘hey, why are you crying?’ She says: ‘I miss my hometown and it is not fair to have to walk away, drop everything and leave it all behind, everything you own, because of other people...’ Back there, she used to work the fields, here she doesn’t. So, the whole situation changes overnight, both psychologically and physically. When you move to a new town because of the armed conflict, life changes by force and so do your roots, your traditions, what you used to enjoy… At least, in Corinto, we used to organize the <b><u><i>{1}kermesses{/1}</i></u></b>, but there’s nothing like that here. As there are a lot of <b><u><i>{2}fincas{/2}</i></u></b>, all families gather together in the same <b><u><i>{3}vereda{/3}</i></u></b> and have parties and barbeques. Here people don’t. People don’t have a sense of community here. In Corinto someone would say, ‘Hey, let’s go plant these things there, in that <i>finca</i>’ and everybody would go.”</p><p><i>Lesbian woman, indigenous, leader</i></p>`,
  },
  tooltips: {
    1: {
