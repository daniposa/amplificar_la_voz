...
export const CHRONICLE_T3_32: LocalizedModalContent = {
  ...
  rawText: {
    ...
    fr: `<p>« Ils ont fait disparaître mon fils, mon propre fils., mon fils bien-aimé… Il ne voulait pas s’impliquer avec eux [...] ils ont tellement insisté qu’un jour, ils lui ont demandé de leur rendre service avec sa moto, et je ne l’ai plus jamais revu. Il faisait le taxi avec sa moto. Pour moi, c’est quelque chose de très dur, parce que les Noirs ne pourront jamais sortir de l’esclavage, on ne les laisse jamais aller de l’avant, et ce qui est encore plus triste, c’est qu’on nous a mis à nous tuer entre nous, à tuer les nôtres, comme des animaux, sans cœur, sans âme. »</p><p><i><b><u>{1}Red Mariposas de Alas Nuevas Construyendo Futuro{/1}</u></b>, « les épines du racisme »</i></p>`,
    en: `<p>“My beloved son was disappeared because he didn’t want to be involved in those things [...] They kept going about it for a long time, until one day they asked him to take them somewhere and I never saw my son again. He drove a motorcycle-taxi. It was hard for me because I realized black people will never leave slavery behind, they will never let us advance, and the hardest part is that they make us kill each other, black people against black people, just like heartless and soulless animals.”</p><p><i><b><u>{1}Red Mariposas de Alas Nuevas Construyendo Futuro{/1}</u></b>, «The thorns of racism»</i></p>`,
  },
  tooltips: {
    1: {
