...
export const CHRONICLE_T1_04: LocalizedModalContent = {
  ...
  rawText: {
    es: '<p>Cerca a Chigorodó está la vereda Tascón, del municipio de Dabeiba. Allí, varios integrantes del Frente 5 de las FARC-EP, incluido un tío de la víctima, violentaron a Angie, mujer lesbiana que entre 1991 y 1994 fue sometida a violaciones, amenazas y tortura, cuando apenas tenía 12 años: «Esto me pasó en varias ocasiones en diferentes veredas. Quedé embarazada de uno de los miembros de las FARC, llamado Juan Carlos, que pertenecía al mismo frente de alias Karina. Por todo eso tuve que irme».</p><p class="identificador"><i>Mujer lesbiana</i></p>',
    fr: '<p>Près de Chigorodó se trouve la <i><b>{1}vereda{/1}</b></i> de Tascón, dans la commune de Dabeiba. Là, plusieurs membres du 5e front des <b>{2}FARC-EP{/2}</b>, dont un oncle de la victime, ont agressé Angie, une femme lesbienne qui a été victime de viols, de menaces et de tortures entre 1991 et 1994, alors qu’elle n’avait que 12 ans : « Ça m’est arrivé à plusieurs reprises dans plein de <i>veredas</i> différentes. Je suis tombée enceinte d’un membre des FARC, un certain Juan Carlos, qui appartenait au même front dont faisait aussi partie celle connue sous le nom de Karina. C’est pour ça que j’ai dû partir. »</p><p class="identificador"><i>Femme lesbienne</i></p>',
    en: '<p>Near the town of Chigorodó, one can find Tascón, a <i><b>{1}vereda{/1}</b></i> in the town of Dadeiba. There, several members of the 5th <b>{2}FARC-EP{/2}</b> Front, including the victim’s own uncle, violently assaulted Angie, a lesbian woman who, between 1991 and 1994, was subjected to rape, threats, and torture, when she was only 12 years old: “This happened to me on several occasions, in different <i>veredas</i>. I got pregnant by one of the FARC members, named Juan Carlos, who belonged to the same front as alias Karina. That is why I had to leave.”</p><p class="identificador"><i>Lesbian woman</i></p>',
  },
  tooltips: {
    1: {
...
<p>Les FARC-EP (<i>Fuerzas Armadas Revolucionarias de Colombia – Ejército del Pueblo</i>) sont une organisation politico-militaire insurgée qui existe depuis plus de 50 ans en Colombie.  </p>`,
  ...
  contextInfo: {
    ...
    en: '<p>Place: <i>Vereda</i> of Tascón, Dadeiba, Urabá (Antioquia)</p><p>Date: 1991-1994</p><p>Victimizing act(s): sexual violence, threats, torture, displacement, forced pregnancy</p><p>Armed actor: FARC-EP 5th Front',
  },
};
